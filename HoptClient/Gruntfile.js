module.exports = function ( grunt ) {
  ...
  grunt.registerTask( 'compileless-min', [
    'recess:compile', 'copy:compile_assets', 'ngmin', 'concat:compile_js', 'index:compile'
  ]);

  grunt.registerTask( 'compileless-ug', [
    'recess:compile', 'copy:compile_assets', 'concat:compile_js', 'uglify', 'index:compile'
  ]);
